...
"SELECT projects.title, SUM(pledges.amount) FROM projects JOIN pledges ON projects.id = pledges.project_id WHERE SUM(pledges.amount) - projects.funding_goal >= 0;"
end
